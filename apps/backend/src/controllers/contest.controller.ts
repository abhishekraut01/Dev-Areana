...
export const getActiveChallenges = asyncHandler(
...
export const getFinishedChallenges = asyncHandler(
  async (req: Request, res: Response, next: NextFunction) => {
...
export const getContestChallenges = asyncHandler(
  async (req: Request, res: Response, next: NextFunction) => {
...
export const submitContest = asyncHandler(
  async (req: Request, res: Response, next: NextFunction) => {
    const { contestId } = req.params;
...
export const getSpecificChallenge = asyncHandler(
  async (req: Request, res: Response, next: NextFunction) => {
...
export const submitChallenge = asyncHandler(
  async (req: Request, res: Response, next: NextFunction) => {
